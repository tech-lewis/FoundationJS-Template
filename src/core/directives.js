        ...
        customFilter: function (handler, selectors) {
            return function (e) {
                var match = selectors.every(function (selector) {
                    if (e.target.matchesSelector) return e.target.matchesSelector(selector)
                    if (e.target.msMatchesSelector) return e.target.webkitMatchesSelector(selector)
                    if (e.target.mozMatchesSelector) return e.target.mozMatchesSelector(selector)
                })
