<template>
  <div class="weui_cell">
    ...
    <div class="weui_cell_ft" v-show="!readonly" style="font-size: 0">
      <a
        @click="sub()"
        class="number-selector number-selector-sub needsclick"
        :class="{ 'number-disabled': disabled_min }"
        >-</a
      >
      <input
        v-model="value"
      ...
      <a
        @click="add()"
        class="number-selector number-selector-plus needsclick"
        :class="{ 'number-disabled': disabled_max }"
        >+</a
      >
    </div>
