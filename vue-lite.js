...
if (!Object.isFrozen) {
    Object.isFrozen = function(obj) {
        // 处理非对象类型（ES5规范中抛出TypeError，这里简化为返回true）
        if (typeof obj !== 'object' || obj === null) {
            return true;
        }

        // 检测对象是否可扩展（使用其他polyfill或默认实现）
        ...
        for (var i = 0; i < properties.length; i++) {
            ...
            // 如果是数据属性，检查是否可写
            if (descriptor.hasOwnProperty('writable') && descriptor.writable) {
                return false;
            }
        }

        // 如果是密封对象，则已经是冻结的（如果不可扩展且所有属性不可配置）
        return true;
    };
}
// 兼容性补丁
...
/***/ function(module, exports) {
	...
	exports.deleteObject = function (obj, key) {
	  if (!obj.hasOwnProperty(key)) {
	    return
	  }
	  delete obj[key]
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.set = _.set
	exports.deleteObject = _.deleteObject
